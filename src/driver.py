...
class Driver():
    ...
    def get(self, url):
        with webdriver.Chrome(executable_path=self.driver_path, chrome_options=self.options) as driver:
        # with webdriver.Chrome(self.driver_path, desired_capabilities=self.options.to_capabilities()) as driver:
            driver.get(str(url))
